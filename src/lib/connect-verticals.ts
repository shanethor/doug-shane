...
export const CONNECT_VERTICALS: ConnectVerticalConfig[] = [
  {
    ...
    subVerticals: [
      ...
      { id: "electrical_residential", label: "Residential Electrical (NCCI 5190 — Inside Wiring)", sources: ["licensing", "permits", "osha_238210", "sos_filings"] },
      { id: "electrical_commercial", label: "Commercial Electrical (NCCI 5190 — Large Permits)", sources: ["licensing", "permits_50k", "osha_238210", "sam_gov"] },
      { id: "electrical_low_voltage", label: "Low-Voltage / Data Cabling (NCCI 7600)", sources: ["licensing", "permits", "iec_directory"] },
      { id: "electrical_fire_alarm", label: "Fire Alarm / Security (NCCI 7605)", sources: ["licensing", "permits", "nfpa"] },
    ...
    coverageLines: [
      ...
      "Workers' Compensation (NCCI 7538 — Outside Line Construction)",
