...
const acord125Fields: AcordFormField[] = [
  ...
  // General Information
  { key: "subsidiary_of_another", label: "1a. Is applicant a subsidiary of another entity?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "parent_company_name", label: "Parent Company Name", type: "text", section: "General Information" },
  { key: "has_subsidiaries", label: "1b. Does applicant have any subsidiaries?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "safety_program", label: "2. Formal safety program in operation?", type: "select", options: ["Yes", "No"], section: "General Information" },
  ...
  { key: "exposure_flammables", label: "3. Exposure to flammables, explosives, chemicals?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "other_insurance_same_company", label: "4. Any other insurance with this company?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "policy_declined_cancelled", label: "5. Policy declined, cancelled or non-renewed in prior 3 years?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "past_sexual_abuse_claims", label: "6. Past losses re: sexual abuse, discrimination, negligent hiring?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "fraud_conviction", label: "7. Applicant convicted of fraud, bribery, arson in last 5 years?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "fire_safety_violations", label: "8. Any uncorrected fire/safety code violations?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "bankruptcy", label: "9. Foreclosure, repossession, or bankruptcy in last 5 years?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "judgement_or_lien", label: "10. Judgement or lien in last 5 years?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "business_in_trust", label: "11. Has business been placed in a trust?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "trust_name", label: "Name of Trust", type: "text", section: "General Information" },
  { key: "foreign_operations", label: "12. Any foreign operations or foreign products?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "other_business_ventures", label: "13. Other business ventures not requesting coverage?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "operates_drones", label: "14. Does applicant own/lease/operate any drones?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "hires_drone_operators", label: "15. Does applicant hire others to operate drones?", type: "select", options: ["Yes", "No"], section: "General Information" },
...
const acord126Fields: AcordFormField[] = [
  ...
  { key: "blasting_explosives", label: "2. Operations include blasting or explosive material?", type: "select", options: ["Yes", "No"], section: "Contractors" },
  { key: "excavation_underground", label: "3. Operations include excavation, tunneling, underground work?", type: "select", options: ["Yes", "No"], section: "Contractors" },
  { key: "subs_less_coverage", label: "4. Subcontractors carry less coverage/limits than yours?", type: "select", options: ["Yes", "No"], section: "Contractors" },
  { key: "subs_without_coi", label: "5. Subcontractors allowed to work without COI?", type: "select", options: ["Yes", "No"], section: "Contractors" },
  { key: "leases_equipment", label: "6. Applicant lease equipment to others?", type: "select", options: ["Yes", "No"], section: "Contractors" },
  ...
  { key: "foreign_products_sold", label: "2. Foreign products sold/distributed/used as components?", type: "select", options: ["Yes", "No"], section: "Products / Completed Operations" },
  { key: "rd_new_products", label: "3. R&D conducted or new products planned?", type: "select", options: ["Yes", "No"], section: "Products / Completed Operations" },
...
const acord127Fields: AcordFormField[] = [
  ...
  // General Information
  { key: "vehicles_not_solely_owned", label: "1. Any vehicles not solely owned by applicant?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "over_50pct_employees_use_autos", label: "2. Over 50% of employees use autos in business?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "vehicle_maintenance_program", label: "3. Vehicle maintenance program in operation?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "vehicles_leased_to_others", label: "4. Any vehicles leased to others?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "modified_vehicles", label: "5. Any car modified / special equipment?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "icc_puc_filings", label: "6. ICC, PUC or other filings required?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "transporting_hazmat", label: "7. Operations involve transporting hazardous material?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "hold_harmless_agreements", label: "8. Any hold harmless agreements?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "vehicles_used_by_family", label: "9. Any vehicles used by family members?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "mvr_verifications", label: "10. Does applicant obtain MVR verifications?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "driver_recruiting_method", label: "11. Specific driver recruiting method?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "drivers_no_wc", label: "12. Any drivers not covered by Workers Compensation?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "vehicles_not_scheduled", label: "13. Vehicles owned but not scheduled?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "drivers_with_violations", label: "14. Drivers with moving traffic violations?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "agent_inspected_vehicles", label: "15. Has agent inspected vehicles?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "all_vehicles_in_fleet", label: "16. All vehicles part of a fleet?", type: "select", options: ["Yes", "No"], section: "General Information" },
...
const acord130Fields: AcordFormField[] = [
  ...
  // General Information
  { key: "wc_aircraft_watercraft", label: "1. Own/operate/lease aircraft/watercraft?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "wc_hazardous_material", label: "2. Operations involve hazardous material?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "wc_underground_above_15ft", label: "3. Work underground or above 15 feet?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "wc_barges_vessels_docks", label: "4. Work on barges, vessels, docks, bridges over water?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "wc_other_business", label: "5. Engaged in any other type of business?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "subcontractors_used", label: "6. Sub-contractors used?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "pct_subcontracted", label: "% of work subcontracted", type: "text", section: "General Information" },
  { key: "wc_work_sublet_no_coi", label: "7. Any work sublet without COI?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "workplace_safety_program", label: "8. Written safety program in operation?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "wc_group_transportation", label: "9. Any group transportation provided?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "wc_under_16_over_60", label: "10. Employees under 16 or over 60?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "seasonal_employees", label: "11. Any seasonal employees?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "wc_volunteer_labor", label: "12. Any volunteer or donated labor?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "wc_physical_handicaps", label: "13. Employees with physical handicaps?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "wc_travel_out_of_state", label: "14. Employees travel out of state?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "wc_athletic_teams", label: "15. Athletic teams sponsored?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "wc_physicals_required", label: "16. Physicals required after employment offers?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "wc_other_insurance_same", label: "17. Other insurance with this insurer?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "wc_prior_declined", label: "18. Coverage declined/cancelled/non-renewed in last 3 years?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "wc_health_plans", label: "19. Employee health plans provided?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "wc_employees_other_business", label: "20. Employees perform work for other businesses?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "wc_lease_employees", label: "21. Lease employees to or from other employers?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "wc_work_at_home", label: "22. Employees predominantly work at home?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "wc_tax_liens_bankruptcy", label: "23. Tax liens or bankruptcy in last 5 years?", type: "select", options: ["Yes", "No"], section: "General Information" },
  { key: "wc_unpaid_premium", label: "24. Undisputed/unpaid WC premium due?", type: "select", options: ["Yes", "No"], section: "General Information" },
...
const acord131Fields: AcordFormField[] = [
  ...
  { key: "explosives_hauled", label: "Explosives/flammables/dangerous cargo hauled?", type: "select", options: ["Yes", "No"], section: "Additional Exposures - Auto" },
  { key: "passengers_for_fee", label: "Passengers carried for a fee?", type: "select", options: ["Yes", "No"], section: "Additional Exposures - Auto" },
  { key: "hired_non_owned_coverage", label: "Hired and non-owned coverages provided?", type: "select", options: ["Yes", "No"], section: "Additional Exposures - Auto" },
  { key: "contractor_bridge_dam", label: "Bridge, dam, or marine work performed?", type: "select", options: ["Yes", "No"], section: "Additional Exposures - Contractors" },
  { key: "contractor_uses_cranes", label: "Own, rent, or use cranes?", type: "select", options: ["Yes", "No"], section: "Additional Exposures - Contractors" },
  { key: "employer_self_insured", label: "Applicant self-insured in any state?", type: "select", options: ["Yes", "No"], section: "Additional Exposures - Employers" },
  { key: "pollution_hazardous_disposal", label: "Products require special hazardous disposal?", type: "select", options: ["Yes", "No"], section: "Additional Exposures - Pollution" },
  { key: "foreign_operations_131", label: "Foreign operations or foreign products?", type: "select", options: ["Yes", "No"], section: "Additional Exposures - Pollution" },
