...
const acord131Fields: AcordFormField[] = [
  ...
  { key: "underlying_auto_policy_number", label: "Auto Policy Number", type: "text", section: "Underlying Insurance" },
  { key: "underlying_auto_eff_date", label: "Auto Policy Eff Date", type: "date", section: "Underlying Insurance" },
  { key: "underlying_auto_exp_date", label: "Auto Policy Exp Date", type: "date", section: "Underlying Insurance" },
  { key: "underlying_auto_csl", label: "Auto CSL Each Accident", type: "currency", section: "Underlying Insurance" },
  { key: "underlying_auto_bi_ea_acc", label: "Auto BI Each Accident", type: "currency", section: "Underlying Insurance" },
  { key: "underlying_auto_bi_ea_per", label: "Auto BI Each Person", type: "currency", section: "Underlying Insurance" },
  { key: "underlying_auto_pd", label: "Auto PD Each Accident", type: "currency", section: "Underlying Insurance" },
  { key: "underlying_auto_csl_premium", label: "Auto CSL Premium", type: "currency", section: "Underlying Insurance" },
  { key: "underlying_auto_bi_premium", label: "Auto BI Premium", type: "currency", section: "Underlying Insurance" },
  { key: "underlying_auto_pd_premium", label: "Auto PD Premium", type: "currency", section: "Underlying Insurance" },
  { key: "underlying_auto_mod_factor", label: "Auto Rating Mod", type: "text", section: "Underlying Insurance" },

  // Underlying Insurance — GL
  { key: "underlying_gl_carrier", label: "GL - Carrier", type: "text", section: "Underlying Insurance" },
  { key: "underlying_gl_policy_number", label: "GL Policy Number", type: "text", section: "Underlying Insurance" },
  { key: "underlying_gl_eff_date", label: "GL Policy Eff Date", type: "date", section: "Underlying Insurance" },
  { key: "underlying_gl_exp_date", label: "GL Policy Exp Date", type: "date", section: "Underlying Insurance" },
  { key: "underlying_gl_occurrence", label: "GL Each Occurrence", type: "currency", section: "Underlying Insurance" },
  { key: "underlying_gl_aggregate", label: "GL General Aggregate", type: "currency", section: "Underlying Insurance" },
  { key: "underlying_gl_products", label: "GL Products & Comp Ops", type: "currency", section: "Underlying Insurance" },
  { key: "underlying_gl_personal", label: "GL Personal & Adv Injury", type: "currency", section: "Underlying Insurance" },
  { key: "underlying_gl_fire_damage", label: "GL Fire Damage", type: "currency", section: "Underlying Insurance" },
  { key: "underlying_gl_med_expense", label: "GL Medical Expense", type: "currency", section: "Underlying Insurance" },
  { key: "underlying_gl_prem_ops_premium", label: "GL Prem/Ops Premium", type: "currency", section: "Underlying Insurance" },
  { key: "underlying_gl_products_premium", label: "GL Products Premium", type: "currency", section: "Underlying Insurance" },
  { key: "underlying_gl_other_premium", label: "GL Other Premium", type: "currency", section: "Underlying Insurance" },
  { key: "underlying_gl_mod_factor", label: "GL Rating Mod", type: "text", section: "Underlying Insurance" },

  // Underlying Insurance — Employers Liability
  { key: "underlying_el_carrier", label: "EL - Carrier", type: "text", section: "Underlying Insurance" },
  { key: "underlying_el_policy_number", label: "EL Policy Number", type: "text", section: "Underlying Insurance" },
  { key: "underlying_el_eff_date", label: "EL Policy Eff Date", type: "date", section: "Underlying Insurance" },
  { key: "underlying_el_exp_date", label: "EL Policy Exp Date", type: "date", section: "Underlying Insurance" },
  ...
  { key: "underlying_el_mod_factor", label: "EL Rating Mod", type: "text", section: "Underlying Insurance" },
