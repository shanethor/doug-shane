...
export const SEMANTIC_ALIASES: Record<string, Record<string, string>> = {
  ...
  "acord-127": {
    ...
    insured_name:           "NamedInsured_FullName_A",
    applicant_name:         "NamedInsured_FullName_A",
    // Driver A – full alias set (no driver_N_name to avoid full-name→first-name collision)
    driver_1_id:            "Driver_ProducerIdentifier_A",
    driver_1_first_name:    "Driver_GivenName_A",
    driver_1_middle:        "Driver_OtherGivenNameInitial_A",
    driver_1_last_name:     "Driver_Surname_A",
    driver_1_city:          "Driver_MailingAddress_CityName_A",
    driver_1_state:         "Driver_MailingAddress_StateOrProvinceCode_A",
    driver_1_zip:           "Driver_MailingAddress_PostalCode_A",
    driver_1_sex:           "Driver_GenderCode_A",
    driver_1_marital:       "Driver_MaritalStatusCode_A",
    driver_1_dob:           "Driver_BirthDate_A",
    driver_1_experience:    "Driver_ExperienceYearCount_A",
    driver_1_licensed_year: "Driver_LicensedYear_A",
    driver_1_license:       "Driver_LicenseNumberIdentifier_A",
    driver_1_ssn:           "Driver_TaxIdentifier_A",
    driver_1_license_state: "Driver_LicensedStateOrProvinceCode_A",
    driver_1_hired_date:    "Driver_HiredDate_A",
    driver_1_no_fault:      "Driver_Coverage_BroadenedNoFaultCode_A",
    driver_1_other_car:     "Driver_Coverage_DriverOtherCarCode_A",
    driver_1_vehicle_id:    "Driver_Vehicle_ProducerIdentifier_A",
    driver_1_vehicle_pct:   "Driver_Vehicle_UsePercent_A",

    // Driver B
    driver_2_id:            "Driver_ProducerIdentifier_B",
    driver_2_first_name:    "Driver_GivenName_B",
    driver_2_middle:        "Driver_OtherGivenNameInitial_B",
    driver_2_last_name:     "Driver_Surname_B",
    driver_2_city:          "Driver_MailingAddress_CityName_B",
    driver_2_state:         "Driver_MailingAddress_StateOrProvinceCode_B",
    driver_2_zip:           "Driver_MailingAddress_PostalCode_B",
    driver_2_sex:           "Driver_GenderCode_B",
    driver_2_marital:       "Driver_MaritalStatusCode_B",
    driver_2_dob:           "Driver_BirthDate_B",
    driver_2_experience:    "Driver_ExperienceYearCount_B",
    driver_2_licensed_year: "Driver_LicensedYear_B",
    driver_2_license:       "Driver_LicenseNumberIdentifier_B",
    driver_2_ssn:           "Driver_TaxIdentifier_B",
    driver_2_license_state: "Driver_LicensedStateOrProvinceCode_B",
    driver_2_hired_date:    "Driver_HiredDate_B",
    driver_2_no_fault:      "Driver_Coverage_BroadenedNoFaultCode_B",
    driver_2_other_car:     "Driver_Coverage_DriverOtherCarCode_B",
    driver_2_vehicle_id:    "Driver_Vehicle_ProducerIdentifier_B",
    driver_2_vehicle_pct:   "Driver_Vehicle_UsePercent_B",

    // Driver C
    driver_3_id:            "Driver_ProducerIdentifier_C",
    driver_3_first_name:    "Driver_GivenName_C",
    driver_3_middle:        "Driver_OtherGivenNameInitial_C",
    driver_3_last_name:     "Driver_Surname_C",
    driver_3_city:          "Driver_MailingAddress_CityName_C",
    driver_3_state:         "Driver_MailingAddress_StateOrProvinceCode_C",
    driver_3_zip:           "Driver_MailingAddress_PostalCode_C",
    driver_3_sex:           "Driver_GenderCode_C",
    driver_3_marital:       "Driver_MaritalStatusCode_C",
    driver_3_dob:           "Driver_BirthDate_C",
    driver_3_experience:    "Driver_ExperienceYearCount_C",
    driver_3_licensed_year: "Driver_LicensedYear_C",
    driver_3_license:       "Driver_LicenseNumberIdentifier_C",
    driver_3_ssn:           "Driver_TaxIdentifier_C",
    driver_3_license_state: "Driver_LicensedStateOrProvinceCode_C",
    driver_3_hired_date:    "Driver_HiredDate_C",
    driver_3_no_fault:      "Driver_Coverage_BroadenedNoFaultCode_C",
    driver_3_other_car:     "Driver_Coverage_DriverOtherCarCode_C",
    driver_3_vehicle_id:    "Driver_Vehicle_ProducerIdentifier_C",
    driver_3_vehicle_pct:   "Driver_Vehicle_UsePercent_C",

    // Driver D
    driver_4_id:            "Driver_ProducerIdentifier_D",
    driver_4_first_name:    "Driver_GivenName_D",
    driver_4_middle:        "Driver_OtherGivenNameInitial_D",
    driver_4_last_name:     "Driver_Surname_D",
    driver_4_city:          "Driver_MailingAddress_CityName_D",
    driver_4_state:         "Driver_MailingAddress_StateOrProvinceCode_D",
    driver_4_zip:           "Driver_MailingAddress_PostalCode_D",
    driver_4_sex:           "Driver_GenderCode_D",
    driver_4_marital:       "Driver_MaritalStatusCode_D",
    driver_4_dob:           "Driver_BirthDate_D",
    driver_4_experience:    "Driver_ExperienceYearCount_D",
    driver_4_licensed_year: "Driver_LicensedYear_D",
    driver_4_license:       "Driver_LicenseNumberIdentifier_D",
    driver_4_ssn:           "Driver_TaxIdentifier_D",
    driver_4_license_state: "Driver_LicensedStateOrProvinceCode_D",
    driver_4_hired_date:    "Driver_HiredDate_D",
    driver_4_no_fault:      "Driver_Coverage_BroadenedNoFaultCode_D",
    driver_4_other_car:     "Driver_Coverage_DriverOtherCarCode_D",
    driver_4_vehicle_id:    "Driver_Vehicle_ProducerIdentifier_D",
    driver_4_vehicle_pct:   "Driver_Vehicle_UsePercent_D",

    // Driver E
    driver_5_id:            "Driver_ProducerIdentifier_E",
    driver_5_first_name:    "Driver_GivenName_E",
    driver_5_middle:        "Driver_OtherGivenNameInitial_E",
    driver_5_last_name:     "Driver_Surname_E",
    driver_5_city:          "Driver_MailingAddress_CityName_E",
    driver_5_state:         "Driver_MailingAddress_StateOrProvinceCode_E",
    driver_5_zip:           "Driver_MailingAddress_PostalCode_E",
    driver_5_sex:           "Driver_GenderCode_E",
    driver_5_marital:       "Driver_MaritalStatusCode_E",
    driver_5_dob:           "Driver_BirthDate_E",
    driver_5_experience:    "Driver_ExperienceYearCount_E",
    driver_5_licensed_year: "Driver_LicensedYear_E",
    driver_5_license:       "Driver_LicenseNumberIdentifier_E",
    driver_5_ssn:           "Driver_TaxIdentifier_E",
    driver_5_license_state: "Driver_LicensedStateOrProvinceCode_E",
    driver_5_hired_date:    "Driver_HiredDate_E",
    driver_5_no_fault:      "Driver_Coverage_BroadenedNoFaultCode_E",
    driver_5_other_car:     "Driver_Coverage_DriverOtherCarCode_E",
    driver_5_vehicle_id:    "Driver_Vehicle_ProducerIdentifier_E",
    driver_5_vehicle_pct:   "Driver_Vehicle_UsePercent_E",

    // Driver F
    driver_6_id:            "Driver_ProducerIdentifier_F",
    driver_6_first_name:    "Driver_GivenName_F",
    driver_6_middle:        "Driver_OtherGivenNameInitial_F",
    driver_6_last_name:     "Driver_Surname_F",
    driver_6_city:          "Driver_MailingAddress_CityName_F",
    driver_6_state:         "Driver_MailingAddress_StateOrProvinceCode_F",
    driver_6_zip:           "Driver_MailingAddress_PostalCode_F",
    driver_6_sex:           "Driver_GenderCode_F",
    driver_6_marital:       "Driver_MaritalStatusCode_F",
    driver_6_dob:           "Driver_BirthDate_F",
    driver_6_experience:    "Driver_ExperienceYearCount_F",
    driver_6_licensed_year: "Driver_LicensedYear_F",
    driver_6_license:       "Driver_LicenseNumberIdentifier_F",
    driver_6_ssn:           "Driver_TaxIdentifier_F",
    driver_6_license_state: "Driver_LicensedStateOrProvinceCode_F",
    driver_6_hired_date:    "Driver_HiredDate_F",
    driver_6_no_fault:      "Driver_Coverage_BroadenedNoFaultCode_F",
    driver_6_other_car:     "Driver_Coverage_DriverOtherCarCode_F",
    driver_6_vehicle_id:    "Driver_Vehicle_ProducerIdentifier_F",
    driver_6_vehicle_pct:   "Driver_Vehicle_UsePercent_F",

    // Driver G
    driver_7_id:            "Driver_ProducerIdentifier_G",
    driver_7_first_name:    "Driver_GivenName_G",
    driver_7_middle:        "Driver_OtherGivenNameInitial_G",
    driver_7_last_name:     "Driver_Surname_G",
    driver_7_city:          "Driver_MailingAddress_CityName_G",
    driver_7_state:         "Driver_MailingAddress_StateOrProvinceCode_G",
    driver_7_zip:           "Driver_MailingAddress_PostalCode_G",
    driver_7_sex:           "Driver_GenderCode_G",
    driver_7_marital:       "Driver_MaritalStatusCode_G",
    driver_7_dob:           "Driver_BirthDate_G",
    driver_7_experience:    "Driver_ExperienceYearCount_G",
    driver_7_licensed_year: "Driver_LicensedYear_G",
    driver_7_license:       "Driver_LicenseNumberIdentifier_G",
    driver_7_ssn:           "Driver_TaxIdentifier_G",
    driver_7_license_state: "Driver_LicensedStateOrProvinceCode_G",
    driver_7_hired_date:    "Driver_HiredDate_G",
    driver_7_no_fault:      "Driver_Coverage_BroadenedNoFaultCode_G",
    driver_7_other_car:     "Driver_Coverage_DriverOtherCarCode_G",
    driver_7_vehicle_id:    "Driver_Vehicle_ProducerIdentifier_G",
    driver_7_vehicle_pct:   "Driver_Vehicle_UsePercent_G",
    // Driver H
    driver_8_id:            "Driver_ProducerIdentifier_H",
    driver_8_first_name:    "Driver_GivenName_H",
    driver_8_middle:        "Driver_OtherGivenNameInitial_H",
    driver_8_last_name:     "Driver_Surname_H",
    driver_8_city:          "Driver_MailingAddress_CityName_H",
    driver_8_state:         "Driver_MailingAddress_StateOrProvinceCode_H",
    driver_8_zip:           "Driver_MailingAddress_PostalCode_H",
    driver_8_sex:           "Driver_GenderCode_H",
    driver_8_marital:       "Driver_MaritalStatusCode_H",
    driver_8_dob:           "Driver_BirthDate_H",
    driver_8_experience:    "Driver_ExperienceYearCount_H",
    driver_8_licensed_year: "Driver_LicensedYear_H",
    driver_8_license:       "Driver_LicenseNumberIdentifier_H",
    driver_8_ssn:           "Driver_TaxIdentifier_H",
    driver_8_license_state: "Driver_LicensedStateOrProvinceCode_H",
    driver_8_hired_date:    "Driver_HiredDate_H",
    driver_8_no_fault:      "Driver_Coverage_BroadenedNoFaultCode_H",
    driver_8_other_car:     "Driver_Coverage_DriverOtherCarCode_H",
    driver_8_vehicle_id:    "Driver_Vehicle_ProducerIdentifier_H",
    driver_8_vehicle_pct:   "Driver_Vehicle_UsePercent_H",
