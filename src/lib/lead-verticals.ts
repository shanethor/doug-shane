...
export const VERTICALS: Vertical[] = [
  ...
  // ── Solar & Solar Installation (NAICS 238220 — Highest premium contractor vertical) ──
  {
    id: "solar_residential",
    label: "Residential Solar (Rooftop PV — NCCI 3724(2)/5551)",
    group: "Contractors",
    sources: [
      s("cslb_c46", "CA CSLB C-46 Solar Contractor License (Bulk CSV)", "file"),
      s("cslb_c10", "CA CSLB C-10 Electrical License (Solar Filter)", "file"),
      s("az_roc_cr39", "AZ ROC CR-39 Solar License", "file"),
      s("nv_c1g", "NV NSCB C-1G Solar License", "file"),
      s("hi_c60", "HI DCCA C-60 Solar Energy Systems", "file"),
      s("nm_ee98", "NM CID EE-98 Solar Photovoltaic", "file"),
      s("nabcep_directory", "NABCEP Certified Professional Directory (5,000+)", "users"),
      s("seia_directory", "SEIA Member Directory (1,000+ Companies)", "users"),
      s("energysage_directory", "EnergySage Installer Directory (1,000+)", "globe"),
      s("solarreviews_directory", "SolarReviews Installer Directory (5,000+)", "globe"),
      s("berkeley_lab_tts", "Berkeley Lab Tracking the Sun (4.5M+ Records — Free CSV)", "file"),
      s("ca_dg_stats", "California DG Stats (Installation Records)", "file"),
      s("osha_238220_solar", "OSHA NAICS 238220 — Fall + Arc Flash Citations", "target"),
      s("obbba_itc_trigger", "OBBBA ITC Termination Signal (All Contractors Affected)", "zap"),
      s("sos_solar", "SOS New Entity Filings — Solar Keywords", "file"),
      s("batchdata_enrich", "BatchData Skip-Tracing ($0.05/record)", "users"),
      s("google_places_enrich", "Google Places Enrichment ($0.017/call)", "map"),
    ],
  },
  {
    id: "solar_commercial",
    label: "Commercial Solar (Ground-Mount / Carport — NCCI 3724(2))",
    group: "Contractors",
    sources: [
      s("cslb_c46", "CA CSLB C-46 Solar Contractor License", "file"),
      s("nabcep_directory", "NABCEP Certified Professional Directory", "users"),
      s("seia_directory", "SEIA Member Directory", "users"),
      s("sam_gov_238220_solar", "SAM.gov NAICS 238220 — Federal Solar Contractors", "globe"),
      s("osha_238220_solar", "OSHA NAICS 238220 — Fall + Electrical Citations", "target"),
      s("obbba_itc_trigger", "OBBBA Commercial ITC Deadline (7/4/2026)", "zap"),
      s("berkeley_lab_tts", "Berkeley Lab Tracking the Sun", "file"),
      s("batchdata_enrich", "BatchData Skip-Tracing", "users"),
      s("linkedin_commercial_solar", "LinkedIn Commercial Solar Contract Signals", "globe"),
    ],
  },
  {
    id: "solar_battery_storage",
    label: "Battery Storage / ESS (NFPA 855 — Pollution Liability Required)",
    group: "Contractors",
    sources: [
      s("nabcep_directory", "NABCEP Certified Professional Directory", "users"),
      s("nfpa_855_compliance", "NFPA 855 Compliance Signal (Battery Storage Mandate)", "zap"),
      s("osha_238220_solar", "OSHA NAICS 238220 Citations", "target"),
      s("sos_solar", "SOS New Entity Filings — Battery/ESS Keywords", "file"),
      s("seia_directory", "SEIA Member Directory", "users"),
      s("batchdata_enrich", "BatchData Skip-Tracing", "users"),
      s("google_places_enrich", "Google Places Enrichment", "map"),
    ],
  ...
  {
    id: "solar_traffic_generators",
    label: "Solar Traffic Generators & Tools",
    group: "Contractors",
    sources: [
      s("wc_code_optimizer_solar", "WC Code Optimizer — 3724(2) vs 5551 Rooftop Split ($35K/yr Savings)", "target"),
      s("itc_deadline_calculator", "ITC Deadline Impact Calculator (OBBBA)", "trending"),
      s("battery_coverage_checker", "Battery Storage Coverage Gap Checker (NFPA 855 + CPL)", "target"),
      s("solar_bankruptcy_monitor", "Solar Bankruptcy Customer Pickup Monitor (100+ in 2024)", "zap"),
      s("nem_impact_calculator", "NEM 3.0 Revenue Impact Calculator", "trending"),
    ],
  },

  // ── Flooring Contractor (NAICS 238330 — Highest misclassification rate) ──
  {
    id: "flooring_hardwood",
    label: "Hardwood Flooring (NCCI 5437 — $6.91/$100, 30%+ Misclassified)",
    group: "Contractors",
    sources: [
      s("cslb_c15", "CA CSLB C-15 Flooring License (Bulk CSV)", "file"),
      s("nwfa_directory", "NWFA Certified Professional Finder (3,500+ Members)", "users"),
      s("cfi_directory", "CFI Certified Flooring Installer Directory (2,000+)", "users"),
      s("wfca_directory", "WFCA Member Directory (3,000+)", "users"),
      s("osha_silica", "OSHA Silica Dust Citations (29 CFR 1926.1153)", "target"),
      s("epa_rrp_flooring", "EPA RRP Certified Firms (Pre-1978 Buildings)", "globe"),
      s("flooring_new_license", "New State Flooring/GC License", "file"),
      s("flooring_license_renewal", "License Expiring Within 60 Days (X-Date)", "zap"),
      s("sos_flooring", "SOS New Entity Filings — Flooring Keywords", "file"),
      s("batchdata_enrich", "BatchData Skip-Tracing ($0.05/record)", "users"),
      s("google_places_enrich", "Google Places Enrichment ($0.017/call)", "map"),
    ],
  },
  {
    id: "flooring_carpet_lvp",
    label: "Carpet / Vinyl / LVP (NCCI 5478 — Lower Rate, Growing Rapidly)",
    group: "Contractors",
    sources: [
      s("cfi_directory", "CFI Certified Flooring Installer Directory", "users"),
      s("wfca_directory", "WFCA Member Directory", "users"),
      s("install_directory", "INSTALL Union Contractor Locator", "users"),
      s("flooring_new_license", "New State Flooring/GC License", "file"),
      s("sos_flooring", "SOS New Entity Filings — Carpet/LVP Keywords", "file"),
      s("batchdata_enrich", "BatchData Skip-Tracing", "users"),
      s("google_places_enrich", "Google Places Enrichment", "map"),
    ],
  },
  {
    id: "flooring_tile_stone",
    label: "Tile & Stone / Terrazzo (NCCI 5348 — Silica Exposure)",
    group: "Contractors",
    sources: [
      s("cslb_c54", "CA CSLB C-54 Tile License (Bulk CSV)", "file"),
      s("ntca_directory", "NTCA Find a Tile Contractor (1,500+ — Five Star Rating)", "users"),
      s("osha_silica", "OSHA Silica Dust Citations (Tile/Stone Cutting)", "target"),
      s("flooring_new_license", "New State Flooring/GC License", "file"),
      s("batchdata_enrich", "BatchData Skip-Tracing", "users"),
      s("google_places_enrich", "Google Places Enrichment", "map"),
    ],
  ...
  {
    id: "flooring_epoxy_concrete",
    label: "Epoxy / Polished Concrete (NCCI 5221 — Highest Flooring Rate $8-$12)",
    group: "Contractors",
    sources: [
      s("flooring_new_license", "New State Flooring/GC License", "file"),
      s("osha_238330", "OSHA NAICS 238330 — Chemical Exposure Citations", "target"),
      s("sos_flooring", "SOS New Entity Filings — Epoxy/Concrete Keywords", "file"),
      s("batchdata_enrich", "BatchData Skip-Tracing", "users"),
      s("google_places_enrich", "Google Places Enrichment", "map"),
    ],
  },
  {
    id: "flooring_traffic_generators",
    label: "Flooring Traffic Generators & Tools",
    group: "Contractors",
    sources: [
      s("wc_code_optimizer_flooring", "WC Code Optimizer — 5437 vs 5478 Split ($17K/yr Savings)", "target"),
      s("silica_compliance_checker", "OSHA Silica Compliance Checker (Table 1 Audit)", "trending"),
      s("rrp_coverage_checker", "EPA RRP Lead Paint Coverage Gap Checker", "target"),
      s("gc_prequalification_tool", "GC Prequalification Readiness Tool (E-Mod + GL Check)", "trending"),
    ],
  },

  // ── Elevator / Escalator Contractor (NAICS 238290 — 42+ State License DBs) ──
  {
    id: "elevator_installation",
    label: "Elevator Installation & Modernization (NCCI 5160 — $7.18/$100)",
    group: "Contractors",
    sources: [
      s("cslb_c11", "CA CSLB C-11 Elevator Contractor (Bulk CSV)", "file"),
      s("elevator_world_directory", "Elevator World Source Directory (900K+ Professionals)", "users"),
      s("naec_directory", "NAEC Member Directory (~600 Firms)", "users"),
      s("neii_directory", "NEII Public Member List (Major OEMs)", "users"),
      s("elevator_new_license", "New State Elevator License (42+ States)", "file"),
      s("elevator_license_renewal", "License Expiring Within 60 Days (X-Date)", "zap"),
      s("osha_238290", "OSHA NAICS 238290 — Elevator Citations", "target"),
      s("sam_gov_238290", "SAM.gov NAICS 238290 — Federal Contractors", "globe"),
      s("sos_elevator", "SOS New Entity Filings — Elevator Keywords", "file"),
      s("nyc_brake_retrofit", "NYC Brake Retrofit Mandate (Surge Signal)", "zap"),
      s("ohio_new_license_2024", "Ohio New Elevator License Requirement (11/1/2024)", "zap"),
      s("batchdata_enrich", "BatchData Skip-Tracing ($0.05/record)", "users"),
      s("google_places_enrich", "Google Places Enrichment ($0.017/call)", "map"),
    ],
  },
  {
    ...
    label: "Elevator Maintenance & Repair (NCCI 5160/8720)",
    group: "Contractors",
    sources: [
      s("elevator_world_directory", "Elevator World Source Directory", "users"),
      s("naec_directory", "NAEC Member Directory", "users"),
      s("naesa_directory", "NAESA Inspector/Authority Directory", "users"),
      s("elevator_new_license", "New State Elevator License", "file"),
      s("osha_238290", "OSHA NAICS 238290 Citations", "target"),
      s("batchdata_enrich", "BatchData Skip-Tracing", "users"),
      s("google_places_enrich", "Google Places Enrichment", "map"),
    ],
  },
  {
    id: "elevator_traffic_generators",
    label: "Elevator Traffic Generators & Tools",
    group: "Contractors",
    sources: [
      s("wc_code_optimizer_elevator", "WC Code Optimizer — 5160 vs 5190 vs 8720 Split ($13K+ Savings)", "target"),
      s("modernization_mandate_tracker", "State Modernization Mandate Tracker (NYC/FL/OH)", "trending"),
      s("elevator_safety_audit", "Elevator Safety Compliance Audit Tool (ASME A17.1)", "trending"),
    ],
  },

  // ── Glazing / Windows Contractor (NAICS 238150 — Highest finishing-trade WC rate) ──
  {
    id: "glazing_architectural",
    label: "Architectural Glazing / Curtain Wall (NCCI 5462 — $9.57/$100)",
    group: "Contractors",
    sources: [
      s("cslb_c17", "CA CSLB C-17 Glazing License (Bulk CSV)", "file"),
      s("nga_directory", "NGA Member Directory (1,900+ Companies)", "users"),
      s("fgia_directory", "FGIA Member Directory (700+)", "users"),
      s("glazing_new_license", "New State Glazing License (8 States — CA/FL/AZ/NV/VA/NC/SC/AL)", "file"),
      s("glazing_license_renewal", "License Expiring Within 60 Days (X-Date)", "zap"),
      s("osha_fall_glazing", "OSHA Fall Protection Citations (Glazing at Height)", "target"),
      s("epa_rrp_glazing", "EPA RRP Certified Firms (Pre-1978 Window Replacement)", "globe"),
      s("ira_25c_expired", "IRA 25C Window Tax Credit Terminated (Revenue Contraction Signal)", "zap"),
      s("sos_glazing", "SOS New Entity Filings — Glazing/Glass Keywords", "file"),
      s("glassbuild_exhibitors", "GlassBuild America Exhibitor List", "users"),
      s("batchdata_enrich", "BatchData Skip-Tracing ($0.05/record)", "users"),
      s("google_places_enrich", "Google Places Enrichment ($0.017/call)", "map"),
    ],
  },
  {
    id: "glazing_auto_glass",
    label: "Auto Glass (NCCI 8393 — Much Lower Rate)",
    group: "Contractors",
    sources: [
      s("nga_directory", "NGA Member Directory", "users"),
      s("glazing_new_license", "New State Glazing License", "file"),
      s("sos_glazing", "SOS New Entity Filings — Auto Glass Keywords", "file"),
      s("batchdata_enrich", "BatchData Skip-Tracing", "users"),
      s("google_places_enrich", "Google Places Enrichment", "map"),
    ],
  },
  {
    id: "glazing_traffic_generators",
    label: "Glazing Traffic Generators & Tools",
    group: "Contractors",
    sources: [
      s("wc_code_optimizer_glazing", "WC Code Optimizer — 5462 vs 5102 Shop Split ($30K/yr Savings)", "target"),
      s("hurricane_glazing_checker", "Hurricane/Wind-Borne Debris Code Compliance Checker", "trending"),
      s("bird_safe_glazing_guide", "Bird-Safe Glazing Code Guide (NYC/SF/Portland)", "trending"),
    ],
  },

  // ── Fire Sprinkler / Suppression (NAICS 238220 — Gov mandate-driven demand) ──
  {
    id: "fire_sprinkler_installation",
    label: "Fire Sprinkler Installation (NCCI 5188 — $1.87/$100)",
    group: "Contractors",
    sources: [
      s("afsa_directory", "AFSA Member Locator (1,000+ Companies)", "users"),
      s("nfsa_directory", "NFSA Searchable Member Directory", "users"),
      s("nafed_directory", "NAFED Equipment Distributor Directory", "users"),
      s("nfpa_directory", "NFPA Member Directory (50,000+)", "users"),
      s("fire_sprinkler_new_license", "New State Fire Sprinkler License (25+ States)", "file"),
      s("fire_sprinkler_license_renewal", "License Expiring Within 60 Days (X-Date)", "zap"),
      s("osha_238220_sprinkler", "OSHA NAICS 238220 — Sprinkler Citations", "target"),
      s("sam_gov_238220_sprinkler", "SAM.gov NAICS 238220 — Federal Fire Protection Contractors", "globe"),
      s("cms_sprinkler_mandate", "CMS Healthcare Sprinkler Mandate (Deadline 7/5/2028)", "zap"),
      s("fl_retrofit_law", "FL Residential High-Rise Retrofit Law (2025-2027)", "zap"),
      s("sos_fire_sprinkler", "SOS New Entity Filings — Fire Sprinkler Keywords", "file"),
      s("nyfsca_directory", "NYFSCA Member Directory (NY-Specific)", "users"),
      s("gfsa_directory", "GFSA Member Directory (GA-Specific — Full Contact)", "users"),
      s("batchdata_enrich", "BatchData Skip-Tracing ($0.05/record)", "users"),
      s("google_places_enrich", "Google Places Enrichment ($0.017/call)", "map"),
    ],
  },
  {
    id: "fire_sprinkler_suppression",
    label: "Chemical Suppression / PFAS Replacement (CPL Required)",
    group: "Contractors",
    sources: [
      s("afsa_directory", "AFSA Member Locator", "users"),
      s("fssa_directory", "FSSA Fire Suppression Systems Association", "users"),
      s("pfas_afff_phaseout", "PFAS/AFFF Phase-Out Signal (DOD 1,000+ Facilities by 10/1/2026)", "zap"),
      s("novec_discontinuation", "3M Novec 1230 Discontinuation (End 2025)", "zap"),
      s("fire_sprinkler_new_license", "New State Fire Sprinkler License", "file"),
      s("osha_238220_sprinkler", "OSHA NAICS 238220 Citations", "target"),
      s("batchdata_enrich", "BatchData Skip-Tracing", "users"),
    ],
  },
  {
    id: "fire_sprinkler_inspection",
    label: "Fire Sprinkler Inspection (NCCI 8720 — Lower Rate)",
    group: "Contractors",
    sources: [
      s("naesa_sprinkler_directory", "NAESA Inspector Association Directory", "users"),
      s("sfpe_directory", "SFPE Fire Protection Engineers (E&O Lead)", "users"),
      s("fire_sprinkler_new_license", "New State Fire Sprinkler License", "file"),
      s("batchdata_enrich", "BatchData Skip-Tracing", "users"),
    ],
  },
  {
    id: "fire_sprinkler_traffic_generators",
    label: "Fire Sprinkler Traffic Generators & Tools",
    group: "Contractors",
    sources: [
      s("wc_code_optimizer_sprinkler", "WC Code Optimizer — 5188 vs 5183 Misclassification ($1,600/yr)", "target"),
      s("cms_mandate_countdown", "CMS Sprinkler Mandate Countdown Timer (7/5/2028)", "trending"),
      s("pfas_cpl_gap_sprinkler", "PFAS/Clean Agent CPL Gap Analyzer", "target"),
      s("pe_acquisition_monitor", "PE Consolidation Churn Monitor (129 Deals 2023)", "trending"),
    ],
  },

  // ── Insulation / Drywall Contractor (NAICS 238310) ──
  {
    id: "insulation_general",
    label: "Insulation (Batt / Blown-In / Rigid — NCCI 5479)",
    group: "Contractors",
    sources: [
      s("cslb_c2", "CA CSLB C-2 Insulation & Acoustical License (Bulk CSV)", "file"),
      s("awci_directory", "AWCI Member Directory (2,400+ Firms — GL Required to Join)", "users"),
      s("nia_directory", "NIA Membership Directory (New Member Announcements)", "users"),
      s("icaa_directory", "ICAA Contractor Locator + Buyers' Guide", "users"),
      s("bpi_locator", "BPI GoldStar Contractor Locator (Weatherization)", "users"),
      s("insulation_new_license", "New State Insulation/GC License (30 States)", "file"),
      s("insulation_license_renewal", "License Expiring Within 60 Days (X-Date)", "zap"),
      s("osha_238310", "OSHA NAICS 238310 Citations", "target"),
      s("doe_wap_data", "DOE Weatherization Assistance Program Data", "globe"),
      s("sos_insulation", "SOS New Entity Filings — Insulation Keywords", "file"),
      s("batchdata_enrich", "BatchData Skip-Tracing ($0.05/record)", "users"),
      s("google_places_enrich", "Google Places Enrichment ($0.017/call)", "map"),
    ],
  },
  {
    id: "insulation_spray_foam",
    label: "Spray Foam (SPF — Highest Premium, CPL Required)",
    group: "Contractors",
    sources: [
      s("spfa_directory", "SPFA Spray Foam Contractor Directory (Public — Radius Search)", "users"),
      s("awci_directory", "AWCI Member Directory", "users"),
      s("insulation_new_license", "New State Insulation/GC License", "file"),
      s("osha_238310", "OSHA NAICS 238310 — Chemical Exposure Citations", "target"),
      s("epa_rrp_insulation", "EPA RRP Certified Firms (Pre-1978 Buildings)", "globe"),
      s("sos_insulation", "SOS New Entity Filings — Spray Foam Keywords", "file"),
      s("batchdata_enrich", "BatchData Skip-Tracing", "users"),
      s("google_places_enrich", "Google Places Enrichment", "map"),
    ],
  },
  {
    id: "drywall_general",
    label: "Drywall / Acoustical Ceilings (NCCI 5445/5020)",
    group: "Contractors",
    sources: [
      s("cslb_c9", "CA CSLB C-9 Drywall License (Bulk CSV)", "file"),
      s("awci_directory", "AWCI Member Directory (2,400+ Firms)", "users"),
      s("fca_directory", "FCA International Local Chapter Directories (7,000+ Total)", "users"),
      s("cisca_directory", "CISCA Ceiling/Interior Systems Directory", "users"),
      s("drywall_new_license", "New State Drywall/GC License", "file"),
      s("osha_238310", "OSHA NAICS 238310 Citations", "target"),
      s("sos_drywall", "SOS New Entity Filings — Drywall Keywords", "file"),
      s("batchdata_enrich", "BatchData Skip-Tracing ($0.05/record)", "users"),
      s("google_places_enrich", "Google Places Enrichment ($0.017/call)", "map"),
    ],
  },
  {
    id: "insulation_fireproofing",
    label: "Fireproofing / Asbestos Abatement (NCCI 5473 — $7-$12/$100)",
    group: "Contractors",
    sources: [
      s("nfca_directory", "NFCA Accredited Fireproofing Contractors", "users"),
      s("hfiaw_directory", "HFIAW Local Signatory Contractor Lists", "users"),
      s("epa_asbestos_abatement", "EPA Asbestos Abatement Certified Firms (All 50 States)", "globe"),
      s("insulation_new_license", "New State Insulation/GC License", "file"),
      s("osha_238310", "OSHA NAICS 238310 — Asbestos Citations", "target"),
      s("batchdata_enrich", "BatchData Skip-Tracing", "users"),
    ],
  },
  {
    id: "insulation_drywall_traffic",
    label: "Insulation/Drywall Traffic Generators & Tools",
    group: "Contractors",
    sources: [
      s("wc_code_optimizer_insulation", "WC Code Optimizer — 5479 vs 5445 Split ($10K/yr Savings)", "target"),
      s("spray_foam_cpl_checker", "Spray Foam CPL Coverage Gap Checker (Isocyanate Off-Gassing)", "target"),
      s("doe_wap_contract_alerts", "DOE WAP Contract Award Alert Network", "trending"),
      s("nj_code_anomaly_checker", "NJ Code 5479 Anomaly Checker (Oil Tank vs Insulation)", "target"),
    ],
  },
