...
const AI_TO_FORM_ALIASES: Record<string, string[]> = {
  ...
  mailing_city: ["city", "premises_city", "garaging_city", "building_city"],
  premises_city: ["premises_city", "city", "garaging_city", "building_city"],
  state: ["state", "premises_state", "garaging_state", "building_state", "rating_state", "wc_part1_states"],
  mailing_state: ["state", "premises_state", "garaging_state", "building_state", "rating_state", "wc_part1_states"],
  premises_state: ["premises_state", "state", "garaging_state", "building_state", "rating_state"],
  zip: ["zip", "premises_zip", "garaging_zip", "building_zip"],
  mailing_zip: ["zip", "premises_zip", "garaging_zip", "building_zip"],
  premises_zip: ["premises_zip", "zip", "garaging_zip", "building_zip"],
  ...
  underlying_auto_policy: ["underlying_auto_policy", "underlying_auto_policy_number"],
  underlying_auto_policy_number: ["underlying_auto_policy_number", "underlying_auto_policy"],
  ...
  underlying_auto_csl_premium: ["underlying_auto_csl_premium", "underlying_auto_premium"],
  underlying_auto_mod_factor: ["underlying_auto_mod_factor"],
  underlying_gl_policy: ["underlying_gl_policy", "underlying_gl_policy_number"],
  underlying_gl_policy_number: ["underlying_gl_policy_number", "underlying_gl_policy"],
  ...
  underlying_gl_prem_ops_premium: ["underlying_gl_prem_ops_premium", "underlying_gl_premium"],
  underlying_gl_mod_factor: ["underlying_gl_mod_factor"],
  underlying_el_policy: ["underlying_el_policy", "underlying_el_policy_number"],
  underlying_el_policy_number: ["underlying_el_policy_number", "underlying_el_policy"],
  ...
  // Other underlying slots
  underlying_other_a_type: ["underlying_other_a_type"],
  underlying_other_a_carrier: ["underlying_other_a_carrier"],
  underlying_other_a_policy_number: ["underlying_other_a_policy_number"],
  underlying_other_a_eff_date: ["underlying_other_a_eff_date"],
  underlying_other_a_exp_date: ["underlying_other_a_exp_date"],
  underlying_other_a_coverage: ["underlying_other_a_coverage"],
  underlying_other_a_csl: ["underlying_other_a_csl"],
  underlying_other_a_premium: ["underlying_other_a_premium"],
  underlying_other_b_type: ["underlying_other_b_type"],
  underlying_other_b_carrier: ["underlying_other_b_carrier"],
  underlying_other_b_policy_number: ["underlying_other_b_policy_number"],
  underlying_other_b_eff_date: ["underlying_other_b_eff_date"],
  underlying_other_b_exp_date: ["underlying_other_b_exp_date"],
  underlying_other_b_coverage: ["underlying_other_b_coverage"],
  underlying_other_b_csl: ["underlying_other_b_csl"],
  underlying_other_b_premium: ["underlying_other_b_premium"],
  // Fleet schedule
  fleet_pp_owned: ["fleet_pp_owned", "private_passenger_owned"],
  fleet_lt_owned: ["fleet_lt_owned", "light_trucks_owned"],
  fleet_mt_owned: ["fleet_mt_owned", "medium_trucks_owned"],
  fleet_ht_owned: ["fleet_ht_owned", "heavy_trucks_owned"],
  fleet_bus_owned: ["fleet_bus_owned", "buses_owned"],
  // CCC
  ccc_location_id: ["ccc_location_id"],
  ccc_property_value: ["ccc_property_value"],
  ccc_occupied_area: ["ccc_occupied_area"],
  ccc_property_description: ["ccc_property_description"],
  // Premium
  umbrella_est_annual_premium: ["umbrella_est_annual_premium", "umbrella_premium"],
  umbrella_deposit_premium: ["umbrella_deposit_premium"],
  umbrella_minimum_earned: ["umbrella_minimum_earned"],
  // Applicant signature
  ...
  per_expiring_policy_number: ["per_expiring_policy_number"],
  loan_number: ["loan_number"],
  gl_trigger: ["gl_trigger"],
  gl_each_occurrence: ["gl_each_occurrence", "each_occurrence"],
  gl_general_aggregate: ["gl_general_aggregate", "general_aggregate"],
  gl_products_comp_ops_agg: ["gl_products_comp_ops_agg", "products_aggregate"],
  gl_personal_adv_injury: ["gl_personal_adv_injury", "personal_adv_injury"],
  gl_damage_to_premises_rented: ["gl_damage_to_premises_rented", "fire_damage"],
  gl_medical_expense: ["gl_medical_expense", "medical_payments"],
  gl_retro_date: ["gl_retro_date"],
  auto_any_auto: ["auto_any_auto"],
  auto_owned_only: ["auto_owned_only"],
  auto_scheduled_only: ["auto_scheduled_only"],
  auto_hired_only: ["auto_hired_only"],
  auto_non_owned_only: ["auto_non_owned_only"],
  auto_combined_single_limit: ["auto_combined_single_limit"],
  auto_bi_per_person: ["auto_bi_per_person"],
  auto_bi_per_accident: ["auto_bi_per_accident"],
  auto_property_damage: ["auto_property_damage"],
  auto_um_uim_limit: ["auto_um_uim_limit", "um_uim_limit"],
  auto_pip_limit: ["auto_pip_limit"],
  auto_med_pay_limit: ["auto_med_pay_limit"],
  vpd_valuation: ["vpd_valuation"],
  vpd_collision_deductible: ["vpd_collision_deductible"],
  vpd_other_than_collision_deductible: ["vpd_other_than_collision_deductible"],
  ...
  excess_aggregate: ["excess_aggregate"],
  excess_sir: ["excess_sir"],
  excess_retro_date: ["excess_retro_date"],
  fees: ["fees"],
  taxes: ["taxes"],
  estimated_total_premium: ["estimated_total_premium"],
